...
// TopicPartitions_ShareGroupDescribeResponse contains a
type TopicPartitions_ShareGroupDescribeResponse struct {
...
func (t *TopicPartitions_ShareGroupDescribeResponse) encode(pe packetEncoder, version int16) (err error) {
	t.Version = version
...
func (t *TopicPartitions_ShareGroupDescribeResponse) decode(pd packetDecoder, version int16) (err error) {
	t.Version = version
...
// Assignment_ShareGroupDescribeResponse contains a
type Assignment_ShareGroupDescribeResponse struct {
	// Version defines the protocol version to use for encode and decode
	Version int16
	// TopicPartitions contains the assigned topic-partitions to the member.
	TopicPartitions []TopicPartitions_ShareGroupDescribeResponse
}

func (a *Assignment_ShareGroupDescribeResponse) encode(pe packetEncoder, version int16) (err error) {
	a.Version = version
...
func (a *Assignment_ShareGroupDescribeResponse) decode(pd packetDecoder, version int16) (err error) {
	a.Version = version
	...
	if numTopicPartitions > 0 {
		a.TopicPartitions = make([]TopicPartitions_ShareGroupDescribeResponse, numTopicPartitions)
		for i := 0; i < numTopicPartitions; i++ {
			var block TopicPartitions_ShareGroupDescribeResponse
...
// Member_ShareGroupDescribeResponse contains the members.
type Member_ShareGroupDescribeResponse struct {
	// Version defines the protocol version to use for encode and decode
	Version int16
	...
	Assignment Assignment_ShareGroupDescribeResponse
}

func (m *Member_ShareGroupDescribeResponse) encode(pe packetEncoder, version int16) (err error) {
	m.Version = version
...
func (m *Member_ShareGroupDescribeResponse) decode(pd packetDecoder, version int16) (err error) {
	m.Version = version
	...
	tmpAssignment := Assignment_ShareGroupDescribeResponse{}
...
// DescribedGroup_ShareGroupDescribeResponse contains each described group.
type DescribedGroup_ShareGroupDescribeResponse struct {
	// Version defines the protocol version to use for encode and decode
	Version int16
	...
	Members []Member_ShareGroupDescribeResponse
	// AuthorizedOperations contains a 32-bit bitfield to represent authorized operations for this group.
	AuthorizedOperations int32
}

func (g *DescribedGroup_ShareGroupDescribeResponse) encode(pe packetEncoder, version int16) (err error) {
	g.Version = version
...
func (g *DescribedGroup_ShareGroupDescribeResponse) decode(pd packetDecoder, version int16) (err error) {
	g.Version = version
	...
	if numMembers > 0 {
		g.Members = make([]Member_ShareGroupDescribeResponse, numMembers)
		for i := 0; i < numMembers; i++ {
			var block Member_ShareGroupDescribeResponse
...
type ShareGroupDescribeResponse struct {
	...
	Groups []DescribedGroup_ShareGroupDescribeResponse
}

func (r *ShareGroupDescribeResponse) encode(pe packetEncoder) (err error) {
...
func (r *ShareGroupDescribeResponse) decode(pd packetDecoder, version int16) (err error) {
	r.Version = version
	...
	if numGroups > 0 {
		r.Groups = make([]DescribedGroup_ShareGroupDescribeResponse, numGroups)
		for i := 0; i < numGroups; i++ {
			var block DescribedGroup_ShareGroupDescribeResponse
...
func (r *ShareGroupDescribeResponse) GetKey() int16 {
	return 77
}

func (r *ShareGroupDescribeResponse) GetVersion() int16 {
	return r.Version
}

func (r *ShareGroupDescribeResponse) SetVersion(version int16) {
	r.Version = version
}

func (r *ShareGroupDescribeResponse) GetHeaderVersion() int16 {
	return 1
}

func (r *ShareGroupDescribeResponse) IsValidVersion() bool {
	return r.Version == 0
}

func (r *ShareGroupDescribeResponse) GetRequiredVersion() int16 {
	// TODO - it isn't possible to determine this from the message format json files
	return 0
}

func (r *ShareGroupDescribeResponse) throttleTime() time.Duration {
